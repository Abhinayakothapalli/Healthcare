                ...
                <div class="login-form">
                    ...
                    <div class="input-boxes">
                        ...
                        <div class="button input-box">
                            <a href="page2.html"><input type="submit" value="Login"></a>
                        </div>
                        <a href="signup.php"><div class="text login-text">Don't have an account? <label for="flip">signup now</a></label></div>
                    </div>
                </div>
	</div>
	</form>
