...
<div class="row">
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body">
        <ul>
          ...
          <li>Application form (English, Hindi, Bengali, Marathi, Oriya, Telugu, Tamil or Gujarati).</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      <p>
  <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample3" role="button" aria-expanded="true" aria-controls="multiCollapseExample1">Eligibility Criteria</a>
  <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample4" role="button" aria-expanded="false" aria-controls="multiCollapseExample2">Documents Required</a>
  <button type="button" class="btn btn-primary">near by hospitals<a href="https://www.google.com/maps/search/near+by+hospital/@17.3669444,78.4072313,14z/data=!3m1!4b1"><i class='fas fa-map-marker-alt' id="maps" style='font-size:25px;color:red;padding-left:5px'></i></a></button>
...
<div class="row">
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card card-body">
      <ul>
      <li>Individuals between 18 to 70 years</li>
          <li>It provide up to 12Lpa</li>
  ...
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body">
        ...
        Link <a href="">https://www.pmjay.gov.in/</a>
